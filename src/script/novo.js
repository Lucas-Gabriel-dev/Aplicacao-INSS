...
function diferenca() {
    ...
    document.querySelector(".amountPaid").innerHTML = OldRMI;
    document.querySelector(".newSalary").innerHTML = newRMI;
    document.querySelector(".dayValue").innerHTML = (ValueDay).toFixed(2);
    document.querySelector(".thirteenth").innerHTML = (ValueThirteenth).toFixed(2);
    document.querySelector(".startOfBenefit").innerHTML = newStartdate;
    document.querySelector(".endOfBenefit").innerHTML = newEndofDate;
    document.querySelector(".complement").innerHTML = (Complement).toFixed(2);
    document.querySelector(".days").innerHTML = days(newStartdate, newEndofDate);  
    document.querySelector(".withoutDiscounts").innerHTML = (ValueToPay).toFixed(2); 
    document.querySelector(".withDiscounts").innerHTML = (Rubrica).toFixed(2); 
